...
\begin{entrylist}
    ...
    {Senior Software Engineer}
    {Meta}
    {Led the development of a public-facing image playground website: \texttt{imagine.meta.com}. Delivered the project within a one-month deadline for the Emu launch. At the time, it was the only free image generation tool, attracting significant media attention and resharing by C-level executives.\\ 
    Within the MetaGen organization, maintained and developed various playgrounds to support new Llama model releases and features, including agent support, side-by-side model comparisons, and file uploads.\\
    Created a debugging tool for MetaGen that tracks each step of the model request lifecycle, from prompt to final answer, highlighting changes to prompts and metadata throughout the process.\\
    Led front-end development for multiple Meta Financial Technologies (MFT) tools, improving internal adoption of new financial products.\\
    Contributed to bringing an NFT wallet viewer to Facebook and Instagram web.\\
    Maintained and modernized the Facebook Stories web viewer, ensuring a smooth Stories experience on \texttt{facebook.com}.\\}
    ...
    {Software Engineer}
    {Yelp}
    {On the website, I worked on the modernization of the web photos experience and the web homepage redesign projects. Both projects required a complete rewrite front-end and back-end. I mainly focused on the front-end side of both projects. The homepage project also required code packaging as part of the micro-services transition, which I lead on the front-end.
    \vspace*{0.5em}
    \\
